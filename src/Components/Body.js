  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.socialContainer}>
        <a href="https://www.linkedin.com/in/kunalgupta26/" target="_blank"><svg className={classes.socialIcons} width="415" height="415" viewBox="0 0 415 415" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://github.com/kunalgupta94" target="_blank">
